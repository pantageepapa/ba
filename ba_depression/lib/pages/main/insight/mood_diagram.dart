...
class MoodDiagram extends StatefulWidget {
  const MoodDiagram({Key? key}) : super(key: key);

  @override
  State<MoodDiagram> createState() => _MoodDiagramState();
}

class _MoodDiagramState extends State<MoodDiagram> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<List<FlSpot>?>(
        future: GraphService().getMoods(
