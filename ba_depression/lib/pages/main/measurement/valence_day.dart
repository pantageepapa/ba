...
class ValenceDay extends StatefulWidget {
  const ValenceDay({Key? key}) : super(key: key);

  @override
  State<ValenceDay> createState() => _ValenceDayState();
}

class _ValenceDayState extends State<ValenceDay> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<List<FlSpot>?>(
        future: GraphService().getValence(
