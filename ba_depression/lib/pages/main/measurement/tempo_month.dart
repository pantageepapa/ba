...
class TempoMonth extends StatefulWidget {
  const TempoMonth({Key? key}) : super(key: key);

  @override
  State<TempoMonth> createState() => _TempoMonthState();
}

class _TempoMonthState extends State<TempoMonth> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<List<FlSpot>?>(
        future: GraphService().getBPMMonth(
